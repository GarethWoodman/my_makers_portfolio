...
describe Card do
  ...
  context "when topped up" do
    ...
    describe '#tap_in' do
        ...
        it "deducts penalty fare if touches in twice in a row without touching out" do
          subject.top_up(10)
          subject.tap_in(entry_station)
    ...
    describe '#tap_out' do
        ...
        it "deducts penalty fare if touches out having not touched in" do
          expect { subject.tap_out(exit_station) }.to change{ subject.balance }.by(-6)
        end
    end
  end
